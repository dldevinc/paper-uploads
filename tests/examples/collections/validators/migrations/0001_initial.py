    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', paper_uploads.models.fields.collection.CollectionField(on_delete=django.db.models.deletion.SET_NULL, storage=None, to='validators_collections.mixedcollection', upload_to='', verbose_name='collection')),
            ],
            options={
                'verbose_name': 'Page',
            },
