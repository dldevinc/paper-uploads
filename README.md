...
Модели файлов (`UploadedFile`, `UploadedImage` и модели элеменов коллекций) 
...
Чтобы экземпляры коллеций не смешивались при выполнении SQL-запросов, 
...
в адмике. Из-за этого, в течение некоторого времени файл
