    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', paper_uploads.models.fields.base.FormattedFileField(max_length=255, storage=django.core.files.storage.FileSystemStorage(), upload_to='files/%Y-%m-%d', verbose_name='file')),
        ...
        migrations.CreateModel(
            ...
            bases=(paper_uploads.models.mixins.ReadonlyFileProxyMixin, 'paper_uploads.collectionitembase', models.Model),
        ),
        migrations.CreateModel(
            name='ImageItem',
            fields=[
